...
members = [
  ...
  "crates/proof/succinct/utils/signer",
  "crates/proof/succinct/utils/elfs",
  "crates/proof/succinct/utils/ethereum/client",
  "crates/proof/succinct/utils/ethereum/host",
  "crates/proof/succinct/scripts/*",
  "crates/proof/succinct/validity",
...
# Consensus
base-consensus-cli = { path = "crates/consensus/cli" }
base-consensus-rpc = { path = "crates/consensus/rpc" }
base-consensus-safedb = { path = "crates/consensus/safedb" }
...
base-consensus-sources = { path = "crates/consensus/sources", default-features = false }
base-consensus-upgrades = { path = "crates/consensus/upgrades", default-features = false }
base-consensus-providers = { path = "crates/consensus/providers", default-features = false }
...
base-bundle-extension = { path = "crates/execution/bundle" }
base-proofs-extension = { path = "crates/execution/proofs" }
base-tx-forwarding = { path = "crates/execution/tx-forwarding" }
...
base-prover-service-client = { path = "crates/proof/prover-service/client" }
...
base-proof-succinct-prove = { path = "crates/proof/succinct/scripts/prove" }
base-proof-succinct-scripts = { path = "crates/proof/succinct/scripts/utils" }
base-proof-succinct-validity = { path = "crates/proof/succinct/validity" }
base-proof-succinct-host-utils = { path = "crates/proof/succinct/utils/host" }
base-proof-succinct-build-utils = { path = "crates/proof/succinct/utils/build" }
...
base-proof-succinct-signer-utils = { path = "crates/proof/succinct/utils/signer" }
base-proof-succinct-ethereum-host-utils = { path = "crates/proof/succinct/utils/ethereum/host" }
base-proof-succinct-ethereum-client-utils = { path = "crates/proof/succinct/utils/ethereum/client" }
